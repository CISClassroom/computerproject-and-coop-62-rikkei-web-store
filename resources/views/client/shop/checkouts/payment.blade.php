                                    ...
                                    <div class="container text-left mt-2 mb-3">
                                        <label class="btn btn-outline-dark icon-payment-mastercard">
                                            <input type="radio" class="hide-radio-btn" name="paymentoption"
                                                id="option-mastercard" value="credit-mastercard">
                                            {{ __('Mastercard') }}
                                        </label>

                                        <label class="btn btn-outline-dark icon-payment-visa">
                                            <input type="radio" class="hide-radio-btn" name="paymentoption"
                                                id="option-visa" value="credit-visa">
                                            {{ __('Visa') }}
                                        </label>
                                    </div>
                                    <span class="text-left">
                ...
                <div class="card-body">
                    ...
                    <div class="row mt-5">
                        <div class="container">
                            ...
                            <button type="submit" class="btn btn-dark rounded-0 btn-lg btn-block text-uppercase">
